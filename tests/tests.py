...
from feefighters.util.remote_object import REQUESTS
from feefighters.util.xml_util import *
from feefighters.util.request_util import RequestUtil
from feefighters.payment_method import PaymentMethod
from feefighters.transaction import Transaction
from feefighters.feefighters import FeeFighters
...
class TestXMLTODict(unittest.TestCase):
    ...
    def test_small_xml(self):
        ...
        out_dict = XmlUtil.xml_to_dict(in_str)
...
class TestDictToXML(unittest.TestCase):
    def test_dict_to_xml(self):
        ...
        xml = XmlUtil.dict_to_xml(payload)
...
class TestBasicRequest(unittest.TestCase):
    ...
    def test_fetch_payment_method_error(self):
        ...
        response = RequestUtil.request( request[0], request[1] % "badkey", test_credentials.merchant_key, test_credentials.merchant_password )
    ...
    def test_fetch_payment_method_success(self):
        ...
        response = RequestUtil.request( request[0], request[1] % payment_method_token, test_credentials.merchant_key, test_credentials.merchant_password )
    ...
    def test_update_payment_method_success(self):
        ...
        response = RequestUtil.request( request[0], request[1] % payment_method_token, test_credentials.merchant_key, test_credentials.merchant_password, payload )
        self.assertEqual(type(response), dict)
...
class TestDjangoModels(unittest.TestCase):
    ...
    def test_sequence_not_through_db_1(self):
        from django_app.models import PaymentMethod, Transaction, User
        import time
